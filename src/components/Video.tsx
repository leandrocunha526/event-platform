            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gap-16">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <a href="" className="flex items-center justify-center gap-2 p-4 text-sm font-bold uppercase transition-colors border rounded border-blug-500 text-blug-500 hover:bg-blue-500 hover:text-gray-900">
                            <Lightning size={24}/>
                            Acesse o desafio
                        </a>
                    </div>
